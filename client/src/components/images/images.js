...
const Image = () => (
    <div>
         <a href="/ProductDescription"><img className="m-2" src="http://accessoryresearch.com/Film%20Cleaner.JPG" height = "200px" alt="Film Cleaner"></img></a>
        <img className="m-2" src="http://accessoryresearch.com/Plastic.JPG" height = "200px" alt="Plastic Cleaner"></img>
